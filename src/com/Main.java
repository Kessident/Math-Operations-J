...
public class Main {
    ...
    private static void showResults(double sum, double difference, double multiplication, double division, double remainder, double num1, double num2) {
        System.out.println("The sum of " + num1 + " and " + num2 + " is: " + sum + "\n" +
                "The difference between " + num1 + " and " + num2 + " is: " + difference + "\n" +
                num1 + " multiplied by " + num2 + " is: " + multiplication + "\n" +
                num2 + " divided by " + num2 + " is: " + division + "\n" +
    ...
    public static void main(String[] args) {
        ...
        showResults(sum, difference, multiplication, division, remainder, operand1, operand2);
    }
}